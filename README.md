...
- `nginx` na porta `9999`
- `api1` e `api2` em Python
- servidor HTTP proprio com `asyncio`
- `orjson` para parse de JSON
- `scipy.spatial.cKDTree` para o KNN exato em um indice compacto de candidatos de borda gerado a partir de `resources/references.json.gz`
